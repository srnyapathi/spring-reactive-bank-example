...
class WithdrawalTransactionHandlerTest {
    ...
    OperationType operationType = new OperationType(4L,
            "WITHDRAWAL", "WITHDRAWAL", TransactionType.DEBIT);
    ...
    void shouldThrowInvalidAmountException_whenAmountIsNegative() {
        ...
        StepVerifier.create(withdrawalTransactionHandler.validate(accountId, BigDecimal.valueOf(amount)))
    ...
    @ParameterizedTest(name = "Should successfully process withdrawal with amount: {0}")
    @CsvSource({
            "100.0",
            "0.01",
            "999999999.99",
    ...
    @DisplayName("Should successfully perform withdrawal transaction with various amounts")
    void shouldPerformWithdrawalTransaction_withVariousAmounts(String amountValue) {
        Long accountId = 1L;
        ...
        StepVerifier.create(withdrawalTransactionHandler.performTransaction(accountId, amount))
    ...
    void shouldThrowInvalidAmountException_whenAmountIsZero() {
        ...
        StepVerifier.create(withdrawalTransactionHandler.validate(accountId, amount))
                .expectError(InvalidAmountException.class)
                .verify();
    }
    ...
    void shouldThrowInvalidAmountException_whenAmountIsNull() {
        ...
        StepVerifier.create(withdrawalTransactionHandler.validate(accountId, null))
                .expectError(InvalidAmountException.class)
                .verify();
    }
    ...
    void shouldThrowInvalidAccountException_whenAccountIdIsNull() {
        ...
        StepVerifier.create(withdrawalTransactionHandler.validate(null, amount))
    ...
    void shouldReturnCorrectHandlerName() {
        String handlerName = withdrawalTransactionHandler.getHandler();

        org.junit.jupiter.api.Assertions.assertEquals("WITHDRAWAL", handlerName);
    }
